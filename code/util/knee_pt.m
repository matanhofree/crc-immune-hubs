function [res_x, idx_of_result] = knee_pt(y,x,just_return,use_absolute_dev)
...
if (nargin > 3 && ~isempty(use_absolute_dev) && use_absolute_dev)
    use_absolute_dev_p = use_absolute_dev;
end
